const Map<String, Map<String, String>> appTranslations = {
  ...
  'kn': {
    ...
    'err_phone_invalid': 'ದಯವಿಟ್ಟು ಮಾನ್ಯವಾದ 10 ಅಂಕಿಯ ಮೊಬೈಲ್ ಸಂಖ್ಯೆಯನ್ನು ನಮೂದಿಸಿ.',
  },
  'ml': {
    'app_title_login': 'Star India - ലോഗിൻ',
    'app_title_signup': 'Star India - അക്കൗണ്ട് ഉണ്ടാക്കുക',
    'header_login': 'നിങ്ങളുടെ അക്കൗണ്ടിലേക്ക് ലോഗിൻ ചെയ്യുക',
    'header_signup': 'Star India-ൽ പുതിയ പ്രൊഫൈൽ ഉണ്ടാക്കുക',
    'sec_personal': 'വ്യക്തിഗത വിവരങ്ങൾ',
    'first_name': 'ആദ്യ പേര് *',
    'last_name': 'അവസാന പേര്',
    'pick_birthdate': 'ജനനത്തീയതി തിരഞ്ഞെടുക്കുക',
    'birthdate_is': 'ജനനത്തീയതി:',
    'city': 'നഗരം / ഗ്രാമം',
    'bio': 'ബയോ / നിങ്ങളെക്കുറിച്ച് ചുരുക്കത്തിൽ',
    'hobbies': 'ഹോബികൾ / താൽപ്പര്യങ്ങൾ',
    'sec_work': 'വിദ്യാഭ്യാസവും തൊഴിലും',
    'edu_label': 'വിദ്യാഭ്യാസ നിലവാരം',
    'edu_primary': 'പ്രാഥമിക വിദ്യാഭ്യാസം',
    'edu_secondary': 'സെക്കൻഡറി വിദ്യാഭ്യാസം',
    'edu_higher_sec': 'ഹയർ സെക്കൻഡറി വിദ്യാഭ്യാസം',
    'edu_college': 'കോളേജ്',
    'edu_higher_college': 'ബിരുദാനന്തര ബിരുദം / ഉന്നത കോളേജ്',
    'edu_degree': 'ബിരുദം / പ്രൊഫഷണൽ',
    'prof_label': 'തൊഴിൽ തരം',
    'prof_business': 'ബിസിനസ്സ് / സ്വയംതൊഴിൽ',
    'prof_private': 'സ്വകാര്യ ജോലി',
    'prof_govt': 'സർക്കാർ ജോലി',
    'prof_freelance': 'പ്രൊഫഷണൽ / ഫ്രീലാൻസർ',
    'prof_student': 'വിദ്യാർത്ഥി',
    'company_name': 'കമ്പനി / വകുപ്പ് / ബിസിനസ്സ് പേര്',
    'designation': 'തസ്തിക / പദവി (Designation)',
    'sec_contact': 'ബന്ധപ്പെടലും സുരക്ഷയും',
    'phone_label': '10 അക്ക മൊബൈൽ നമ്പർ *',
    'sec_phone_label': 'രണ്ടാമത്തെ മൊബൈൽ നമ്പർ (ഓപ്ഷണൽ)',
    'email_label': 'ഇമെയിൽ വിലാസം',
    'pwd_label': 'പാസ്‌വേഡ് (കുറഞ്ഞത് 6 അക്ഷരങ്ങൾ) *',
    'login_id_label': 'ഇമെയിൽ അല്ലെങ്കിൽ 10 അക്ക മൊബൈൽ നമ്പർ',
    'login_pwd_label': 'പാസ്‌വേഡ്',
    'sec_social': 'സോഷ്യൽ മീഡിയ ലിങ്കുകൾ',
    'whatsapp': 'WhatsApp ലിങ്ക് / നമ്പർ',
    'instagram': 'Instagram പ്രൊഫൈൽ',
    'facebook': 'Facebook പ്രൊഫൈൽ ലിങ്ക്',
    'twitter': 'Twitter (X) പ്രൊഫൈൽ ലിങ്ക്',
    'btn_login': 'ലോഗിൻ ചെയ്യുക',
    'btn_signup': 'അക്കൗണ്ട് ഉണ്ടാക്കി ആരംഭിക്കുക',
    'switch_to_signup': 'പുതിയ അക്കൗണ്ട് വേണോ? സൈൻ അപ്പ് ചെയ്യുക',
    'switch_to_login': 'ഇതിനകം അക്കൗണ്ട് ഉണ്ടോ? ലോഗിൻ ചെയ്യുക',
    'err_pwd_len': 'പാസ്‌വേഡിന് കുറഞ്ഞത് 6 അക്ഷരങ്ങൾ ഉണ്ടായിരിക്കണം.',
    'err_empty_login': 'ദയവായി ഇമെയിൽ അല്ലെങ്കിൽ മൊബൈൽ നമ്പർ നൽകുക.',
    'err_empty_name': 'ദയവായി പേരും മൊബൈലോ ഇമെയിലോ നൽകുക.',
    'err_phone_invalid': 'ദയവായി സാധുവായ 10 അക്ക മൊബൈൽ നമ്പർ നൽകുക.',
  },
  'pa': {
    'app_title_login': 'Star 
